...
def main():
    ...
    while True:
        ...
        ap.add_argument("--if", dest="iface", default="wlan0")
        ap.add_argument("--out", dest="out", default="/data/wifi_rssi_log.csv")  # default into /data
        ...
        df.to_csv(args.out, mode="a", index=False, header=header)
